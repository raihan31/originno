package com.originno.raihan.config;

import com.originno.raihan.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.originno.raihan.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.originno.raihan.repository.search")
